...
# --- 派生変数 (メールアドレスなど) ---
# GOOGLE_CLOUD_PROJECT が設定されている場合のみ実行
if [ -n "$GOOGLE_CLOUD_PROJECT" ]; then
    export SERVICE_ACCOUNT_EMAIL="${BACKEND_SA_NAME}@${GOOGLE_CLOUD_PROJECT}.iam.gserviceaccount.com"
    export TRIGGER_SERVICE_ACCOUNT_EMAIL="${TRIGGER_SA_NAME}@${GOOGLE_CLOUD_PROJECT}.iam.gserviceaccount.com"
    export FUNCTION_SERVICE_ACCOUNT_EMAIL="${FUNCTION_SA_NAME}@${GOOGLE_CLOUD_PROJECT}.iam.gserviceaccount.com"
